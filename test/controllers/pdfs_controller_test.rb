...
class PdfsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pdf" do
    assert_difference('Pdf.count') do
      post pdfs_url, params: { pdf: { description: @pdf.description, name: @pdf.name, pdfdoc: @pdf.pdfdoc, user_id: @pdf.user_id } }
    end
  ...
  test "should update pdf" do
    patch pdf_url(@pdf), params: { pdf: { description: @pdf.description, name: @pdf.name, pdfdoc: @pdf.pdfdoc, user_id: @pdf.user_id } }
